...
/**
 * Contoh penggunaan PBE tanpa menggunakan sebuah PBEParameterSpec
 */
public class ContohPBETanpaParameter
{
    public static void main(String[] args) throws Exception
    {
        ...
        //mengenkripsi data menggunakan kunci yang telah dihitung
        ...
        byte[] hasil = cEnk.doFinal(masukan);
        ...
        cDek.init(Cipher.DECRYPT_MODE, sKunci);

        System.out.println("cipher : " + Utils.toHex(hasil));
        System.out.println("kunci: " + Utils.toHex(sKunci.getEncoded()));
        System.out.println("iv : " + Utils.toHex(cDek.getIV()));
        System.out.println("plain  : " + Utils.toHex(cDek.doFinal(hasil)));
    }
}